...
namespace BTL06.Controllers
{
    public class KhoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KhoID,SanPhamName,NumberKho,KhoStoreExists,ExportKho")] Kho kho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("KhoID,SanPhamName,NumberKho,KhoStoreExists,ExportKho")] Kho kho)
        {
            if (id != kho.KhoID)
            {
                return NotFound();
